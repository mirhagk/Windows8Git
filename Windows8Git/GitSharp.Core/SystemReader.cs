        ...
        */
        ...
        private class InternalSystemReader : SystemReader
        {
            ...
            public override FileBasedConfig openUserConfig()
            {
                ...
                return new FileBasedConfig(new StorageFile(Path.Combine(home.FullName, ".gitconfig")));
            }
            ...
            public override FileBasedConfig getConfigFile(ConfigFileType configType)
            {
               	...
               	switch (configType)
            	{
               	...
               	StorageFile info = new StorageFile(filename);
               	if (info != null)
            ...
            {
            	StorageFile info = new StorageFile(fileLocation);
            	if (info != null)
            		return (new FileBasedConfig(info));
               	else
               		throw new FileNotFoundException();
